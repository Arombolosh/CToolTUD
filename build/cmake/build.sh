...
cd $CMAKELISTSDIR &&
mkdir -p ../../bin/release &&
echo "*** CToolConverter to bin/release ***" &&
if [ -d $BUILDDIR/CToolConverter/CToolConverter.app ]
then
	# MacOS
	rm -rf ../../bin/release/CToolConverter.app &&
	cp -r $BUILDDIR/CToolConverter/CToolConverter.app ../../bin/release/CToolConverter.app &&
    echo "All files copied successfully."
else
	if [ -e $BUILDDIR/CToolConverter/CToolConverter ]
	then
		cp $BUILDDIR/CToolConverter/CToolConverter ../../bin/release/CToolConverter
	fi
fi
