...
public:
	...
	enum distribution_t {
		...
		/*! Short wave radiation on surface is distributed based on surface type (see fraction parameters).
			Hereby, the sum of all fraction parameters must be equal to 1.
		*/
	...
	/*! Parameter values. */
	enum para_t {
		/*! Fraction of total radiation loads attributed to room node. This parameter is used for both SWR_AreaWeighted and SWR_SurfaceTypeFactor. */
