...
namespace NANDRAD {
	...
	const char * const ENUM_TYPES[88] = {
	...
	const char * KeywordList::Description(const char * const enumtype, int t, bool * no_description) {
		...
		switch (enum2index(enumtype)) {
			...
			case 28 :
			switch (t) {
				case 0 : if (no_description != nullptr) *no_description = true; return "Floor";
				case 1 : if (no_description != nullptr) *no_description = true; return "Ceiling";
				case 2 : if (no_description != nullptr) *no_description = true; return "Wall";
			...
			switch (t) {
				...
				case 1 : return "Short wave transmittance (hemispherical) for diffuse radiation";
			} break;
			// WindowGlazingSystem::splinePara_t
			case 82 :
			switch (t) {
