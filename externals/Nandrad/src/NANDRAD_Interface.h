...
public:
	...
	/*! Defines usage type of this interface.
		This information is used, for example, for the solar radiation distribution model.
	*/
	enum usage_t {
		U_Floor,						// Keyword: Floor
		U_Ceiling,						// Keyword: Ceiling
		U_Wall,							// Keyword: Wall
		U_Other,						// Keyword: Other
		NUM_U
	};
	...
	*/
	...
	bool haveSolarAbsorption() const;
	...
	/*! Usage type of this interface. */
	usage_t										m_usage = U_Other;		// XML:A
