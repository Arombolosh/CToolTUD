...
public:
	...
	*/
	static bool migrateProject(TiXmlElement * rootElement, IBK::Version & srcVersion, Project &prj);

private:
	/*! Migrates project version from 1.0 to 1.1 */
	static void migrateVersion_1_0(TiXmlElement * rootElement, IBK::Version & newVersion, Project &prj);
	/*! Migrates project version from 1.1 to 1.2 */
	static void migrateVersion_1_1(TiXmlElement * rootElement, IBK::Version & newVersion, Project &prj);
};
