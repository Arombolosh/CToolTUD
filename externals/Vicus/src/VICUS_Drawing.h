...
public:
	...
	*/
	...
	struct Field {
		...
		Field() {}
		Field(const VICUS::Drawing &drawing, const IBKMK::Vector3D &p):
...
#define PICK_DRAWING_LINES
	...
	/*! Current Bounding box size. Is updated in VICUS::Project. */
	mutable IBKMK::Vector3D													m_boundingBox;

	/*! Field size for faster snapping access. Is updated in VICUS::Project. */
